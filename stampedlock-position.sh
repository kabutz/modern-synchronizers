...
pushd src
javac -d ../out/production/modern-synchronizers eu/javaspecialists/concurrent/playground/stampedlock/Position*.java
popd
java -cp out/production/modern-synchronizers eu/javaspecialists/concurrent/playground/stampedlock/PositionTest
