...
git pull
cd src
javac -d ../out/production/modern-synchronizers eu/javaspecialists/concurrent/playground/stampedlock/IntList*.java
cd ..
java -cp out/production/modern-synchronizers eu/javaspecialists/concurrent/playground/stampedlock/IntListTest
